...
import me.whereareiam.socialismus.common.config.defaults.SettingsDefaults;
...
public class SettingsProvider extends DefaultConfigProvider<Settings> {
	...
	protected Configura configura() {
		return versioned(super.configura().withDefaults(SettingsDefaults.class), Settings.class);
	}
}
