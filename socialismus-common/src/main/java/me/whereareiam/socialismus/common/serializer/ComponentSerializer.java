...
@Singleton
public class ComponentSerializer implements ComponentService, SerializationWorker {
	...
	@Inject
	public ComponentSerializer(Provider<Messages> messages, Provider<Settings> settings, Provider<Set<Integration>> integrations) {
