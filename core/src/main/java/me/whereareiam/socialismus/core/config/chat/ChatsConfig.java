package me.whereareiam.socialismus.core.config.chat;
...
public class ChatsConfig extends YamlSerializable {
	@Comment(
			value = {
					...
					@CommentValue(type = CommentValue.Type.TEXT),
					@CommentValue("     Here you can specify the message format."),
					...
					@CommentValue("       format: \"<red>{playerName}: <white>{message}\""),
					@CommentValue("       This option allows you to specify the permission that the player must have to use this"),
					@CommentValue("       format."),
					@CommentValue("       permission: \"whereareiam.is.the.best\""),
					@CommentValue(type = CommentValue.Type.TEXT),
