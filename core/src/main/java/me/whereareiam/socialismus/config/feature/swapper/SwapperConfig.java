...
public class SwapperConfig extends YamlSerializable {
    ...
    @Comment(
            value = {
                    ...
                    @CommentValue(type = CommentValue.Type.TEXT),
                    @CommentValue(" If you have any suggestions for improvements to this feature, please feel free to"),
                    ...
                    @CommentValue("     Content list allows you to specify a list of content to replace a placeholder with."),
