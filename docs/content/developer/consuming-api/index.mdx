...
Socialismus publishes API artifacts to the public Maven repository:

- public repository: [https://registry.whereareiam.me/maven/packages](https://registry.whereareiam.me/maven/packages)
...
If you intentionally target development builds instead of releases, use the matching development version from the public repository.
...
Both kinds of version are published to the public `packages` repository:

- release versions are built from GitHub release tags
- development versions are built from branch builds
...
Each published API includes a Javadoc JAR in the public `packages` repository:

- Socialismus API latest release: <MavenVersionLink
    metadataUrl="https://registry.whereareiam.me/maven/packages/me/whereareiam/socialismus/api/maven-metadata.xml"
    hrefTemplate="https://registry.whereareiam.me/maven/packages/me/whereareiam/socialismus/api/{version}/api-{version}-javadoc.jar"
    selector="release"
  />
...
- Socialismus module API latest release: <MavenVersionLink
    metadataUrl="https://registry.whereareiam.me/maven/packages/me/whereareiam/socialismus/module/api/maven-metadata.xml"
    hrefTemplate="https://registry.whereareiam.me/maven/packages/me/whereareiam/socialismus/module/api/{version}/api-{version}-javadoc.jar"
    selector="release"
  />
