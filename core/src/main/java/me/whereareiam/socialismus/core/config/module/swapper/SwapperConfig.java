package me.whereareiam.socialismus.core.config.module.swapper;
...
public class SwapperConfig extends YamlSerializable {
	...
	@Comment(
			value = {
					...
					@CommentValue("       - \":lol:\""),
					@CommentValue(type = CommentValue.Type.TEXT),
					@CommentValue("     Here you can set requirements for using this swapper."),
					@CommentValue("     requirements:"),
					@CommentValue("       enabled: true"),
					@CommentValue("       use-permission: \"swapper.test\""),
